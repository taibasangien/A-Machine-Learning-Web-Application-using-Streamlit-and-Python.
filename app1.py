...
def main():
    ...
    st.markdown('Are you Diabetic or not!🤢')
    st.sidebar.markdown('Are you Diabetic or not!🤢')
    image = Image.open('Image.jpg')
    st.image(image, caption='Diabetes Disease Prediction', use_column_width=True)

    @st.cache(persist=True)
    def load_data():
        data = pd.read_csv("C:\\Users\\LENOVO\\Desktop\\DP\\diabetes.csv")
        return data
